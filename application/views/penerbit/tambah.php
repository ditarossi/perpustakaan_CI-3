<div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form method="post" action="<?= base_url()?>penerbit/input" class="form-horizontal">
              <div class="box-body">
                <div class="form-group">
                  <label class="col-sm-2 control-label">ID Penerbit</label>
                  <div class="col-sm-10">
                    <input name="ID_Penerbit" value="<?= $ID_Penerbit; ?>" type="text" class="form-control" placeholder="ID Penerbit" readonly>
                  </div>
                </div>
                <div class="form-group">
